...
public class StringEx01 {
    public static void main(String[] args) {
        ...
        //= 기준으로 앞숫자문자열과 뒤숫자를 분리하여 각각 출력하여 출력하세요

        String firstNum = ssn1.substring(0,5);
        ...
        //7.***완전 많이씀******* 문자열 분리 : split()*여러개의 문자열로 구성시, 이를 따로 분리해서 문자열을 처리하고 싶다.**********
        //이를 따로 분리해서 문자열을 처리하고 싶다. 구분자(delimiter)이용.
