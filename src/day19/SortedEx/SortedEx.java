...
//스트림 내에서 요솧를 오름차순 정렬( 자연순서) 또는 사용자 정의 비교기에 따라 정렬 할 수 있다.)
public class SortedEx {
    public static void main(String[] args) {
        ...
        List<String> sortedNames2 = names2.stream().filter(name -> name.startsWith("D")).map(String::toUpperCase)
